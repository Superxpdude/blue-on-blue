# File for all constant defines for BlueOnBlue
# Other files should explicitly import the defines they want to use from here
...
SCONF_ROLE_TIMEOUT = "role_timeout"
SCONF_ROLE_VERIFY = "role_verify"
...
SCONF_GOLD_MONTH_COST = "gold_month_cost"
